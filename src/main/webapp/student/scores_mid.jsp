...
<%
            ...
            sql.append("WHERE s.exam_type = ? AND s.stu_id = ? ");
...
%>
                <tr>
                    <td colspan="<%= courseNames.size() + 2 %>" class="text-center text-muted">暂无期中成绩。</td>
                </tr>
<%
                }
%>
...
%>
    <div class="alert alert-danger">加载期中成绩失败：<%=e.getMessage()%></div>
<%
    } finally {
