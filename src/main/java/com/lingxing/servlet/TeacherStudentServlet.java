...
public class TeacherStudentServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        resp.sendRedirect(req.getContextPath() + "/teacher/index.jsp#students");
    }
    ...
    private void handleEdit(HttpServletRequest req) throws SQLException {
        ...
        StudentDao dao = new StudentDao();
        Student current = dao.findById(stuId);
        ...
        String classNumTwo = String.format("%02d", Integer.parseInt(classNum));
        String stuNumber = classChanged ? generateStudentNumber(year, classNumTwo) : current.getStuNumber();
        String stuClass = year + "级" + classNum + "班";
